...
@section('content')
    ...
    <div class="container">
        ...
        <div class="about-container">
            ...
            <p>My experience covers Server Configuration, Database Administration, HTML5, Security, git Version Control System, Agile/Scrum, Business Development, Search Engine Optimization, and probably more.</p>
