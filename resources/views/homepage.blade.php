...
@section('content')
    ...
    <div class="container">
        ...
        <div class="about-container">
            <p class="mt-3">I'm a Full Stack Web, API developer, and Video Game Historian with over 6 years of industry experience in crafting highly usable fully scalable interactive web applications.</p>

            <p>I am based in Los Angeles, CA. I work in <a class="hover-up" href="https://laravel.com" target="_blank">Laravel - The PHP Framework for Web Artisans</a> because I like things that are good, and use a test-driven (TDD) development approach to ensure things don't break. I'm fluent in all aspects of the software development stack, including .</p>
